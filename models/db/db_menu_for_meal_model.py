...
class MenuForMeal(db.Model):
    ...
    section_id = db.Column(postgresql.UUID(as_uuid=True),
                           db.ForeignKey(Sections.section_id, onupdate="CASCADE", ondelete="CASCADE"),
                           nullable=False)
    dish_id = db.Column(postgresql.UUID(as_uuid=True),
                        db.ForeignKey(Dish.dish_id, onupdate="CASCADE", ondelete="CASCADE"), nullable=False)
